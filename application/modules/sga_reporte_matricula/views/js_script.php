...
<script >
    ...
    function js_reportes(vtipo) {
        ...
        if (vtipo == 'pdf') {
            $("#frmReporteMatriculas").attr("action", "<?= BASE_URL ?>sga_reporte_matricula/printsPdf/")
        }
        if (vtipo == 'excel') {
            $("#frmReporteMatriculas").attr("action", "<?= BASE_URL ?>sga_reporte_matricula/printsExcel/");
        }
