...
<!-- Código de instalación Cliengo para Ffernandox@hotmail.com -->
<script type="text/javascript">
  /*  (function () { 
        var ldk = document.createElement('script');
        ldk.type = 'text/javascript'; 
        ldk.async = true; 
        ldk.src = 'https://s.cliengo.com/weboptimizer/6075c7d170c550002a0e97bb/6075c7d370c550002a0e97be.js?platform=registration'; 
                    ...
                    &nbsp;<button type="button"   id="btnPagar" name="btnPagar" onclick="js_registrarPago();" class="btn btn-danger"><i class="glyphicon glyphicon-share" /></i> Registrar Pago                
                        &nbsp;<button type="button"   id="btnImprimir" name="btnImprimir" onclick="js_imprimir();" class="btn btn-primary"><i class="glyphicon glyphicon-print" /></i> Imprimir EE.CC  
                           <!-- &nbsp;<button type="button"   id="btnConcepto" name="btnConcepto" onclick="js_concepto();" class="btn btn-primary"><i class="glyphicon glyphicon-share" /></i> Agregar Concepto  -->
                            &nbsp;<button type="button"   id="btnBoletas" name="btnConcepto" onclick="js_verBoletas();" class="btn btn-danger"><i class="glyphicon glyphicon-share" /></i> Ver Boletas 
                                </td>
                                </tr>
                                </table>
                                </form>
                                                            ...
                                                            <div class="form-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-2" style="display:none;">
                                                                        <select name="cbtipo" id="cbtipo"  class="form-control input-sm">                                
                                                                            <option value="C" selected="selected">CAJA</option>
                                                                    ...
                                                                    <div class="col-md-3">                               
                                                                        <input type="text" id="txtdni"  name="txtdni" class="form-control"  maxlength="8" placeholder="Ingrese DNI" >
                                                                    </div>
                                                                    <div class="col-md-1">
                                                                        <button type="button"  id="btnFiltrar" data-toggle="tooltip" title="Buscar por RENIEC" disabled=""  class="btn btn-primary"><i class="glyphicon glyphicon-search"></i></button>                                                                 
                                                                    </div>

                                                                    <label class="control-label col-md-1 col-sm-offset-2">FECHA</label>
                                                                    <div class="col-md-3">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6">                               
                                                                        <input type="text" id="txtcliente"  disabled="" name="txtcliente" class="form-control"  maxlength="10" >
                                                                    </div>
                                                                    <div class="col-md-4 ">           
                                                                        <div class="custom-control custom-radio custom-control-inline">                                                                    
                                                                            <input class="form-check-input" type="radio" name="rbdLineaApoderados" id="rbdApo1" disabled="" value="P" >
                                                                            <label class="form-check-label" for="inlineRadio2">PAPÁ</label>
                                                                            <input class="form-check-input" type="radio" name="rbdLineaApoderados" id="rbdApo2" disabled="" value="M" >
                                                                            <label class="form-check-label" for="inlineRadio2">MAMÁ</label>             
                                                                        </div>                                                                  
                                                                    </div>                                                                    
                                                                </div>
                                                                ...
                                                                <table class="table table-striped table-bordered"    id="viewBoletasAlumno" style="width: 100%">
                                                                    <thead>
                                                                        <tr class="tableheader">
                                                                            ...
                                                                            <th style="width: 40%;text-align: center">Comprobante</th>    
                                                                            <th style="width: 10%;text-align: center">&nbsp;</th>  
                                                                        </tr>
                                                                    <thead>
                                                                    <tbody>
