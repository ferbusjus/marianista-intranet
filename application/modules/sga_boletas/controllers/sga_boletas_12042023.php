...
# BLOQUE BIMESTRE 2
            ...
            if ($vunidad >= 4) {
                ...
                $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($vnota4) : $vnota4, 1, 0, 'C', TRUE);
            } else {
                $this->pdf->SetXY(109, $yCurso);
                $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
            }
...
# BLOQUE BIMESTRE 5
            if ($vunidad >= 8) {
                ...
                if ($vpromGABimestre1 != '' && $vpromGABimestre2 != '' && $vpromGABimestre3 != '' && $vpromGABimestre4 != '') {
                    ...
                    $vpromFinalGACual = $this->getCualitativo((int) $vpromFinalGACuant);
                }
            ...
            if ($this->ano >= 2022) {
                ...
                $this->pdf->SetFont('Arial', 'B', 6);
                $this->pdf->SetXY(20, $yCurso);
                $this->pdf->Cell(60, 5, utf8_decode('COMPORTAMIENTO'), 1, 0, 'L', TRUE);
                ...
                $this->pdf->SetFillColor(255, 255, 255);
                $this->pdf->SetXY(80, $yCurso);
                $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan1, $alumno->INSTRUCOD) : $notacondCuan1, 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 2) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(87, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan2, $alumno->INSTRUCOD) : $notacondCuan2, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(87, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 2) {
                    ...
                    $this->pdf->Cell(8, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($vpromCondBimestre1, $alumno->INSTRUCOD) : $vpromCondBimestre1, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(208, 222, 240);
                    $this->pdf->SetXY(94, $yCurso);
                    $this->pdf->Cell(8, 5, '', 1, 0, 'C', TRUE);
...
# BLOQUE BIMESTRE 2
                if ($vunidad >= 3) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(102, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan3, $alumno->INSTRUCOD) : $notacondCuan3, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(102, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 4) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(109, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan4, $alumno->INSTRUCOD) : $notacondCuan4, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetXY(109, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                }
                ...
                if ($vunidad >= 4) {
                    ...
                    $this->pdf->Cell(8, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($vpromCondBimestre2, $alumno->INSTRUCOD) : $vpromCondBimestre2, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(208, 222, 240);
                    $this->pdf->SetXY(116, $yCurso);
                    $this->pdf->Cell(8, 5, '', 1, 0, 'C', TRUE);
...
# BLOQUE BIMESTRE 3
                if ($vunidad >= 5) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(124, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan5, $alumno->INSTRUCOD) : $notacondCuan5, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(124, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 6) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(131, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan6, $alumno->INSTRUCOD) : $notacondCuan6, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(131, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 6) {
                    ...
                    $this->pdf->Cell(8, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($vpromCondBimestre3, $alumno->INSTRUCOD) : $vpromCondBimestre3, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(208, 222, 240);
                    $this->pdf->SetXY(138, $yCurso);
                    $this->pdf->Cell(8, 5, '', 1, 0, 'C', TRUE);
...
# BLOQUE BIMESTRE 4
                if ($vunidad >= 7) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(146, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan7, $alumno->INSTRUCOD) : $notacondCuan7, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(146, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 8) {
                    ...
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(153, $yCurso);
                    $this->pdf->Cell(7, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($notacondCuan8, $alumno->INSTRUCOD) : $notacondCuan8, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(255, 255, 255);
                    $this->pdf->SetXY(153, $yCurso);
                    $this->pdf->Cell(7, 5, '', 1, 0, 'C', TRUE);
                ...
                if ($vunidad >= 8) {
                    ...
                    $this->pdf->Cell(8, 5, ($vFlagCuantitativo) ? $this->getCualitativoStandar($vpromCondBimestre4) : $vpromCondBimestre4, 1, 0, 'C', TRUE);
                } else {
                    $this->pdf->SetFillColor(208, 222, 240);
                    $this->pdf->SetXY(160, $yCurso);
                    $this->pdf->Cell(8, 5, '', 1, 0, 'C', TRUE);
...
# ================================ BLOQUE AREAS ===================================
            ...
            foreach ($dataCursoOficial as $rowcur) {
                ...
                if ($vunidad >= 8) {
                    ...
                    //echo "->".(int) $vpromAreaCuan."-".$alumno->REPITE."<br>";
                ...
                $this->pdf->SetTextColor(0, 0, 204);
                $this->pdf->SetXY(146, $yCursoOficial);
                $this->pdf->Cell(8, 5,''/* ($rowcur->cursocod==='10')?'A':''*/, 1, 0, 'C', TRUE); // Se Agrega temporal para los cursos XX - FERBUSXXX
...
# BLOQUE AUTONOMA
            ...
            if ($vunidad >= 8) {
                ...
                if ($vpromGABimestre1 != '' && $vpromGABimestre2 != '' && $vpromGABimestre3 != '' && $vpromGABimestre4 != '') {
                    ...
                    $vpromFinalCONCual = $this->getCualitativo((int) $vpromFinalCONCuant);
                }
                if ($vpromFinalCONCuant > 10 && $vpromFinalCONCuant <= 20) {
                    $this->pdf->SetTextColor(0, 0, 204);
                } else {
